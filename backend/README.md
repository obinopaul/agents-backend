...
The backend includes a fully integrated Agent System accessible via `/api/v1/agent`.

**Key Features:**
- **Chat**: Streaming multi-agent conversation (`/api/v1/agent/chat/stream`)
- **Generation**: Podcast, PPT, and prose generation
- **Tools**: Web search, TTS, and MCP integration
- **Docs**: See [docs/agent-system.md](../docs/agent-system.md) for full details.
