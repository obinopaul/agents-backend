"""
Build the E2B sandbox template for PRODUCTION.

Usage (from project root):
    python backend/build_prod.py

This rebuilds the 'agents-sandbox' template using the E2B CLI,
...
def build():
    print(
        f"Building PRODUCTION template 'agents-sandbox' "
    ...
    print("\nProduction template build complete.")
