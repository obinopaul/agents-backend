...
- SlideContentProcessor: Replaces local sandbox URLs with permanent storage URLs
...
from backend.src.services.slides.content_processor import (
    SlideContentProcessor,
