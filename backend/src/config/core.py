"""Core configuration classes for sandbox infrastructure.
...
Originally from ptc_agent.config.core, integrated into this project.
"""
...
class CoreConfig(BaseModel):
    ...
    LLM configuration is handled separately.
    """
