...
from backend.src.sandbox_server.models.payload import (
...
class SandboxClient:
    ...
    async def upload_file_from_url(
        ...
        from backend.src.sandbox_server.models.payload import UploadFileFromUrlRequest
    ...
    async def download_to_presigned_url(
        ...
        from backend.src.sandbox_server.models.payload import DownloadToPresignedUrlRequest
