...
from backend.src.sandbox_server.logger import logger
...
def run_migrations():
    try:
        ...
        alembic_cfg = Config("~/.backend.src.sandbox_server/alembic.ini")
        migrations_path = "~/.backend.src.sandbox_server/migrations"
