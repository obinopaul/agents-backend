...
from backend.src.evals.logging import logger
...
class Evaluator:
    ...
    def __init__(self):
        ...
        self.client = openai.AsyncOpenAI(api_key=settings.OPENAI_API_KEY, base_url=settings.OPENAI_API_BASE)
        self.langfuse = Langfuse(public_key=settings.LANGFUSE_PUBLIC_KEY, secret_key=settings.LANGFUSE_SECRET_KEY)
        # Initialize report data structure
        self.report = initialize_report(settings.OPENAI_MODEL)
