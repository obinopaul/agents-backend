...
class ChatStreamManager:
    ...
    def _init_postgresql(self) -> None:
        ...
        try:
            ...
            if not settings.get("AGENT_SKIP_DB_SETUP", False):
...
_default_manager = ChatStreamManager(
    checkpoint_saver=getattr(settings, "LANGGRAPH_CHECKPOINT_SAVER", False),
    db_uri=getattr(settings, "LANGGRAPH_CHECKPOINT_DB_URL", "mongodb://localhost:27017"),
)
