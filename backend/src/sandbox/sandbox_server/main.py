...
from backend.src.sandbox.sandbox_server.config import SandboxConfig, SandboxServerConfig
...
from backend.src.sandbox.sandbox_server.db.model import Base
from backend.src.sandbox.sandbox_server.db.manager import engine
...
if __name__ == "__main__":
    ...
    config = SandboxServerConfig()
    uvicorn.run(
        "backend.src.sandbox.sandbox_server.main:app", host=config.host, port=config.port, reload=True
    )
