...
class CreateSandboxResponse(BaseModel):
    ...
    latex_editor_url: Optional[str] = None  # LaTeX Editor URL (port 9001)
    design_url: Optional[str] = None  # Design MCP Server URL (port 6002)
    excalidraw_url: Optional[str] = None  # Excalidraw URL (port 6003)
    graphiti_url: Optional[str] = None  # Graphiti MCP HTTP URL (port 8500) - Knowledge Graph
