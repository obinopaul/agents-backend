...
from backend.src.module.quant.template import apply_prompt_template, get_prompt_template
...
# ADJUST THIS 
from backend.src.module.quant.types import State
...
async def _setup_and_execute_agent_step(
    ...
    *,
    ...
    print(f"\n{'='*60}", flush=True)
    print(f"[DEBUG SETUP] Creating agent with {len(loaded_tools)} total tools (role={role}):", flush=True)
