...
from backend.src.module.excalidraw.template import apply_prompt_template, get_prompt_template
...
# ADJUST THIS 
from backend.src.module.excalidraw.types import State
...
async def _setup_and_execute_agent_step(
    ...
    *,
    ...
    if SUBAGENT_AVAILABLE and CompiledSubAgent is not None:
        try:
            from backend.src.module.excalidraw.sub_builder import graph as workflow_graph
