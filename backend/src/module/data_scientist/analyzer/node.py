...
from backend.src.module.data_scientist.template import apply_prompt_template, get_prompt_template
...
# ADJUST THIS 
from backend.src.module.data_scientist.types import State
...
async def _setup_and_execute_agent_step(
    ...
    *,
    ...
    if SUBAGENT_AVAILABLE and CompiledSubAgent is not None:
        try:
            from backend.src.module.data_scientist.sub_builder import graph as workflow_graph
