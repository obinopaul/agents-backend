...
The Claude Code agent uses a different toolset configured through `.deepagents/settings.json`.
...
1. **Automatic Loading**: Skills are automatically cloned to `.deepagents/skills/` when the coding agent starts
