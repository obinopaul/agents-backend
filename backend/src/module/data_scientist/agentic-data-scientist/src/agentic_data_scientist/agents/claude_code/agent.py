...
def setup_skills_directory(working_dir: str) -> None:
    """
    Clone claude-scientific-skills repository and copy skills to .deepagents/skills/.
...
5. Create final execution summary when done"""
            ...
            # Skills are loaded from .deepagents/skills/ via setting_sources
            # MCP servers are loaded from .deepagents/settings.json via setting_sources
